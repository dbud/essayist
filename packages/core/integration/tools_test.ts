...
Deno.test("integration: list_files -- model discovers files", async () => {
...
Deno.test("integration: grep -- model searches for pattern across files", async () => {
...
Deno.test("integration: read_file + write_file -- model reads then transforms", async () => {
